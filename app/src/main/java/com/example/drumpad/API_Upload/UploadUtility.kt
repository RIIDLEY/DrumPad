package com.example.drumpad.API_Upload
...
class UploadUtility(activity: Activity) {
    ...
    var serverURL: String = "http://lahoucine-hamsek.site/UploadToServer.php"
    var serverUploadDirectoryPath: String = "http://lahoucine-hamsek.site/uploads/"
